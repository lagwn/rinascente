...
<div class="form-step-indicator">
    <div class="form-step-item active"><span>1</span>入力</div>
    <div class="form-step-line"></div>
    <div class="form-step-item"><span>2</span>確認</div>
    <div class="form-step-line"></div>
    <div class="form-step-item"><span>3</span>完了</div>
</div>
...
<!-- ═══════════════════════════════════
     ...
     ═══════════════════════════════════ -->
<div class="form-step-indicator">
    <div class="form-step-item done"><span>1</span>入力</div>
    <div class="form-step-line active"></div>
    <div class="form-step-item active"><span>2</span>確認</div>
    <div class="form-step-line"></div>
    <div class="form-step-item"><span>3</span>完了</div>
</div>
...
<div class="form-step-indicator">
    <div class="form-step-item done"><span>1</span>入力</div>
    <div class="form-step-line active"></div>
    <div class="form-step-item done"><span>2</span>確認</div>
    <div class="form-step-line active"></div>
    <div class="form-step-item active"><span>3</span>完了</div>
</div>
