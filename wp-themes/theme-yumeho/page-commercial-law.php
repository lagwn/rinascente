...
<style>
    .yumeho-legal-hero-line {
        display: block;
    }

    .yumeho-legal-hero-line + .yumeho-legal-hero-line {
        margin-top: 0.18em;
    }

    .yumeho-legal-hero-line--pc-break {
        display: inline;
        margin-top: 0;
    }
    ...
    .yumeho-legal-lead__line--pc-break {
        display: inline;
    }
...
<section class="hero bg-light">
    <div class="container text-center">
        <p class="hero-en">COMMERCE</p>
        <h1 class="hero-title"><?php the_title(); ?></h1>
        <p class="hero-subtitle">
            販売条件や支払い方法、返品・キャンセルの考え方など、
            <span class="yumeho-legal-hero-line--pc-break">お取引に関する基本情報をまとめています。</span>
        </p>
    </div>
</section>
    ...
    <div class="container">
        <div class="yumeho-legal-shell">
            <div class="yumeho-legal-lead animate-on-scroll">
                <div class="yumeho-legal-lead__eyebrow">Commercial Law</div>
                <p>
                    ご契約前に確認いただきたい販売事業者情報や、
                    <span class="yumeho-legal-lead__line--pc-break">商品代金以外の費用、支払い・引渡し条件を整理しています。</span>
                </p>
            </div>

            <article class="yumeho-legal-card animate-on-scroll">
                <div class="yumeho-legal-meta">
                    <div class="yumeho-legal-meta__label">YUMEHO Commerce</div>
