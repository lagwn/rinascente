...
<style>
    ...
    <section class="hero bg-light">
        <div class="container text-center">
            ...
            <h1 class="hero-title">導入事例</h1>
            <p class="hero-subtitle cases-hero-subtitle">病院・介護施設・デイサービスでの<br>課題解決と運用成果をご紹介します</p>
        </div>
    </section>

    <?php
    // facility_type タクソノミーから施設種別を取得
    $facility_terms = get_terms( array(
        'taxonomy'   => 'facility_type',
        'hide_empty' => true,
    ) );

    // 全事例を取得（is_hidden=true は除外）
    ...
    <section class="section">
        <div class="container">
            <?php if ( ! empty( $facility_terms ) && ! is_wp_error( $facility_terms ) ) : ?>
            <!-- Tabs -->
            <div class="tabs">
            ...
            yumeho_render_internal_pathways(
                ...
                array(
                    ...
                    'intro' => '病院・介護施設・デイサービスでの導入事例を見ながら、製品構成、概算費用、導入前の確認事項も続けて整理できます。',
                )
            );
            ?>
