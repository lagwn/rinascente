...
<!-- ═══════════════════════════════════
     STEP 1: 入力
     ═══════════════════════════════════ -->
<div class="form-step-progress" style="display:flex;align-items:center;justify-content:center;gap:8px;margin-bottom:32px;font-size:0.85rem;color:rgba(0,0,0,0.4);">
    <span style="color:var(--primary-color);font-weight:700;">1. 入力</span>
    <span>→</span>
    <span>2. 確認</span>
    <span>→</span>
    <span>3. 完了</span>
...
<div class="form-step-progress" style="display:flex;align-items:center;justify-content:center;gap:8px;margin-bottom:32px;font-size:0.85rem;color:rgba(0,0,0,0.4);">
    <span>1. 入力</span>
    <span>→</span>
    <span style="color:var(--primary-color);font-weight:700;">2. 確認</span>
    <span>→</span>
    <span>3. 完了</span>
</div>
...
<div class="form-step-progress" style="display:flex;align-items:center;justify-content:center;gap:8px;margin-bottom:32px;font-size:0.85rem;color:rgba(0,0,0,0.4);">
    ...
    <span>2. 確認</span>
    <span>→</span>
    <span style="color:var(--primary-color);font-weight:700;">3. 完了</span>
</div>
