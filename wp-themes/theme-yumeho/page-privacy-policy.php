...
<section class="hero bg-light">
    <div class="container text-center">
        <p class="hero-en">PRIVACY</p>
        <h1 class="hero-title"><?php the_title(); ?></h1>
        <p class="hero-subtitle">
            <span class="yumeho-legal-hero-line">YUMEHO サイトで取得する情報の取り扱いと、</span>
            <span class="yumeho-legal-hero-line">個人情報保護に関する考え方をまとめています。</span>
        </p>
    </div>
</section>
    ...
    <div class="container">
        <div class="yumeho-legal-shell">
            <div class="yumeho-legal-lead animate-on-scroll">
                <div class="yumeho-legal-lead__eyebrow">Privacy Policy</div>
                <p>
                    <span class="yumeho-legal-lead__line">資料請求やお問い合わせ、導入相談を安心してご利用いただけるよう、</span>
                    <span class="yumeho-legal-lead__line">取得する情報の内容と利用目的、管理方法を分かりやすく整理しています。</span>
                </p>
            </div>

            <article class="yumeho-legal-card animate-on-scroll">
                <div class="yumeho-legal-meta">
                    <div class="yumeho-legal-meta__label">YUMEHO Privacy</div>
